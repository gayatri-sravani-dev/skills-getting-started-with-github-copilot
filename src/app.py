...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the school basketball team for practice and matches",
        "schedule": "Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "jordan@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Participate in soccer drills and friendly games",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(status_code=404, detail="Email not registered or not registered")
